    ...
    <form action="" class="form-horizontal frmAdd" method="POST" id="frmAdd" name="frmAdd"
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-9">
                ...
                <br>
                <div class="col-md-12" id="privewIMG" @if(isset($data['product_media'])&&$data['product_media']!='') rel="1" @else  rel="0"  @endif>
                    @if(isset($data['product_media'])&&$data['product_media']!='')
                        <i class="fa fa-remove red" id="xoa-media" title="xóa"></i>
                        <img src="{{ThumbImg::thumbBaseNormal(\App\model\Product::FOLDER,$id,$data['product_media'],400,400,'',true,true,true)}}" width="100%"/>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="product_gif" value="1"
                               @if((isset($data['product_gif'])&&$data['product_gif']==1)||old('product_gif')==1) checked @endif />
                        Quà tặng
                    </label>
                </div>
                <div class="checkbox">
