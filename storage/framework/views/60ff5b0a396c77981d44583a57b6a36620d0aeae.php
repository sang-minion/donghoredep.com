...
<?php $__env->startSection('content'); ?>
    <form action="" class="form-horizontal frmAdd" method="POST" id="frmAdd" name="frmAdd" enctype="multipart/form-data">
        ...
        <div class="form-group<?php echo e(isset($errors)&& $errors->has('banner_link') ? ' has-error' : ''); ?>">
            <label for="banner_link" class="col-md-2 col-sm-3 control-label">Link video intro</label>
            <div class="col-md-6 col-sm-9">
        ...
        <div class="form-group">
            <label for="banner_media" class="col-md-2 col-sm-3 control-label">Hình ảnh danh mục</label>
            <div class="col-md-6 col-sm-9">
        ...
        <div class="form-group">
            <label for="product_status" class="col-md-2 col-sm-3 control-label">Vị trí banner</label>
            <div class="col-md-6 col-sm-9">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="banner_index" value="1"
                               <?php if((isset($data['banner_index'])&&$data['banner_index']==1)||old('banner_index')==1): ?> checked <?php endif; ?> />
                        Trang trủ
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="banner_category" value="1"
                               <?php if((isset($data['banner_category'])&&$data['banner_category']==1)||old('banner_category')==1): ?> checked <?php endif; ?> />
                        Trang danh mục sản phẩm
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="banner_details" value="1"
                               <?php if((isset($data['banner_details'])&&$data['banner_details']==1)||old('banner_details')==1): ?> checked <?php endif; ?> />
