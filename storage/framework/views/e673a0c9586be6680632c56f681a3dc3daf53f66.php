    ...
    <div class="container index">
        <div class="col-md-12 index-rows-1">
            <div class="col-md-6 col-sm-6 col-larges">
                <a href="">
                    <img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>">
                </a>
            </div>
        ...
        <div class="col-md-12 index-rows-2">
            ...
            <ul>
                <li>
                    <img src="<?php echo e(asset('resources/assets/media/A1.png')); ?>">
                    <div>
                        Rẻ nhất thị trường càng mua càng rẻ
                    </div>
                </li>
                <li>
                    <img src="<?php echo e(asset('resources/assets/media/A2.png')); ?>">
                    <div>
                        Quà tặng nhiều nhất thị trường
                    </div>
                </li>
                <li>
                    <img src="<?php echo e(asset('resources/assets/media/A3.png')); ?>">
                    <div>
                        Giao tận tay trên toàn quốc
                    </div>
                </li>
                <li>
                    <img src="<?php echo e(asset('resources/assets/media/A4.png')); ?>">
                    <div>
                        Giao hàng nhanh nhất
                    </div>
                </li>
                <li>
                    <img src="<?php echo e(asset('resources/assets/media/A5.png')); ?>">
                    <div>
        ...
        <div class="col-md-12 index-rows-4">
            <div class="title-row border-green1">
                <div class="title-rows-left">
                    <img class="green1" src="<?php echo e(asset('resources/assets/media/C8.png')); ?>">
        ...
        <div class="col-md-12 index-rows-4">
            <div class="title-row border-yealow1">
                <div class="title-rows-left">
                    <img class="yealow1" src="<?php echo e(asset('resources/assets/media/C8.png')); ?>">
                    <div class="inner-title">
                        <b>Đồng hồ nam</b>
			...
			<ul>
				<li >
					<a href="javascript:viod(0)">
						<img src="<?php echo e(asset('resources/assets/media/icon-comment-3.jpg')); ?>">
						<h4>khách hàng 1</h4>
				...
				<li >
					<a href="javascript:viod(0)">
						<img src="<?php echo e(asset('resources/assets/media/icon-comment-2.png')); ?>">
						<h4>khách hàng 1</h4>
						<div>nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1</div>
					</a>
				</li>
				<li >
					<a href="javascript:viod(0)">
						<img src="<?php echo e(asset('resources/assets/media/icon-comment-1.png')); ?>">
						<h4>khách hàng 1</h4>
						<div>nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1 nhận xét của khách hàng 1</div>
					</a>
				</li>
        ...
        <div class="col-md-12 index-rows-4">
            <div class="title-row border-pink1">
                <div class="title-rows-left">
                    <img class="pink1" src="<?php echo e(asset('resources/assets/media/C8.png')); ?>">
                    <div class="inner-title">
                        <b>Đồng hồ nữ</b>
	...
	<div class="index-brand-partner">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<div role="tabpanel" class="tab-pane  fade in active" id="lislogoBrand">
				<ul>
					<li><a href=""><img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>"/></a></li>
					<li><a href=""><img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>"/></a></li>
					<li><a href=""><img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>"/></a></li>
					<li><a href=""><img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>"/></a></li>
					<li><a href=""><img src="<?php echo e(asset('resources/assets/media/3129039169_185513348.jpg')); ?>"/></a></li>
