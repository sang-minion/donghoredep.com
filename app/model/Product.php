...
class Product extends Model
{
    ...
    public static function searchByCondition($search = array(),$limit=0,$offset=0,&$total=0){
        ...
        try{
            ...
            if(isset($search['product_gif'])&&$search['product_gif']!=-1){
                $query->where('product_gif',$search['product_gif']);
            }
            ...
            if(isset($search['product_best'])&&$search['product_news']!=-1){
                $query->where('product_best',$search['product_news']);
            }
